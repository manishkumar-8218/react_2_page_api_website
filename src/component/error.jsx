...
const Error = () => {
    ...
    <div className="h-screen w-screen flex flex-wrap justify-center content-end md:content-center items-end md:items-center relative z-10">
        <div className="p-6 text-center ">
            ...
            <Link to="/api" class="mt-6 bg-blue-500 hover:bg-blue-700 text-white font-light py-4 px-6 rounded-full inline-block uppercase shadow-2xl">Back To Homepage</Link>
        </div>
    </div>
</div>
        </div>
